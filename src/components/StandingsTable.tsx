...
export const StandingsTable: React.FC<StandingsTableProps> = ({ stats, onSelectPlayer }) => {
    ...
    <div className="space-y-4">
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-neutral-800 bg-neutral-950/80 text-[11px] uppercase tracking-wider text-neutral-400 font-bold">
              ...
              <th className="py-3 px-2 text-center text-neutral-400" title="Lost">L</th>
              ...
              <th className="py-3 px-4 text-center font-black text-red-500 text-xs" title="Points (3 per win)">PTS</th>
      ...
      <div className="flex flex-wrap items-center justify-between text-xs text-neutral-400 px-2 py-1 gap-2">
        ...
        <div className="flex items-center gap-1 text-neutral-500">
          ...
          <span>Tie-breakers: Points &gt; Leg Diff &gt; Legs For &gt; 3-Dart Avg</span>
        </div>
      </div>
    </div>
  );
